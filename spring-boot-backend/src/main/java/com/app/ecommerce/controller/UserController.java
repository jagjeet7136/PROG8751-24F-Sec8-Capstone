...
//        SecurityContextHolder.getContext().setAuthentication(authentication);  // not required now but standard practice is to keep it here
    ...
    public void passwordResetEmailVerification(@RequestParam String email){
        ...
        if (user.getAccountStatus() != AccountStatus.ACTIVE) {
            ...
            throw new ForbiddenException("User account is not active: " + user.getAccountStatus());
        }
